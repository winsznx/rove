...
export function evaluateRouteConstraints(
  ...
  let primaryRejection: Rejection | undefined;
  ...
  if (
    intent.max_observed_execution_cost_bps !== undefined &&
  ...
  if (
    intent.max_estimated_carry_bps !== undefined &&
